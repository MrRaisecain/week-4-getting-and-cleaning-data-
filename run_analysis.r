...
setwd("C:\Users\Provise\Desktop\data_science\week4 getting and cleaning data\UCI HAR Dataset\UCI HAR Dataset")
library(plyr)
library(data.table)
...
##organising and combining raw datasets into single 
...
##organising and combining all data sets into single one 
